 ...
 * Version: 1.0
 */
public class PrintBinaryTreeLeftRight {
        ...
        for (int i=0;i<list.size();i++){
            if (map.get(list.get(i))<result.size()){
                if (map.get(list.get(i))%2==0)
                    ...
                    result.get(map.get(list.get(i))).add(0,list.get(i).val);
            }
            else {
    ...
    public static void main(String[] args) {
        ...
        PrintBinaryTreeLeftRight printBinaryTreeMultiLine = new PrintBinaryTreeLeftRight();
        ArrayList<ArrayList<Integer>> print = printBinaryTreeMultiLine.Print(t);
